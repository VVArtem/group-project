...
function convertYmlToJson(xmlFile, jsonFile) {
    ...
    try {
        ...
        for (let i = 0; i < offerNodes.length; i++) {
            ...
            for (let j = 0; j < paramNodes.length; j++) {
                ...
                productData.params[paramName] = param.textContent;
            }
...
convertYmlToJson('../assets/bd/019e038c33d39d4f2d5f519b3e852c06.xml', '../assets/bd/catalog.json');